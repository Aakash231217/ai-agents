...
function ChatUi() {
    ...
    const onSendMessage = async () => {
        ...
        try {
            ...
            if (autoSpeak && selectedVoice) {
                setTimeout(() => speakText(assistantResponse), 500);
            }
        } catch (error) {
            console.error('Error sending message:', error);
            setMessages(prev => [
    ...
    return (
        <div className="chat-ui-container flex flex-col h-full max-h-screen">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {isSpeaking && (
                        <Button
                            ...
                            size="sm"
                            onClick={stopSpeaking}
                            className="h-8 px-2 sm:px-3 text-red-600"
                        >
                            Stop
                        </Button>
                    )}
            ...
            {/* Chat messages - responsive scrollable area */}
            <div 
                ref={chatRef}
                                ...
                                <div className="prose prose-sm sm:prose max-w-none">
                                    <ReactMarkdown
                                        ...
                                        components={{
                                            ...
                                            pre: ({children}) => (
                                                <pre className="overflow-x-auto bg-gray-800 text-gray-100 p-2 sm:p-3 rounded text-xs sm:text-sm">
                                                    {children}
                                                </pre>
                                            )
                                        }}
            ...
            <div className="chat-input-area border-t bg-white p-3 sm:p-4 sticky bottom-0">
                <div className="flex gap-2 sm:gap-3 items-end">
                    <div className="flex-1 min-w-0">
                        <Input
                            ...
                            placeholder="Type your message..."
                            disabled={loading}
                            className="resize-none min-h-[40px] sm:min-h-[44px] text-sm sm:text-base"
                        />
                    </div>
