...
function EmptyChatState() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-[60vh] px-4 sm:px-6 lg:px-8 w-full max-w-4xl mx-auto'>
      {/* Beta Disclaimer */}
      <motion.div
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      <div className='mb-6 sm:mb-8 relative w-full'>
        ...
        <motion.div
          ...
          className='text-center'
        >
          <SparklesText className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-600 px-2'>
            {assistant?.id ? "How can I Assist You?" : "Choose Your Assistant"}
          </SparklesText>
          
          <p className='text-gray-400 mt-3 text-sm sm:text-base text-center max-w-xs sm:max-w-md mx-auto px-2'>
            {assistant?.id ? 
              "Type your question to begin the conversation" : 
              "Select one of your AI assistants below to start chatting"}
          </p>
